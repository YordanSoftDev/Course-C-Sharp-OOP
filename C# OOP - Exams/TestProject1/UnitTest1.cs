...
public class Tests_0_2
{
    ...
    [Test]
    public void ValidateCampaignProperties()
    {
        var type = GetType("Campaign");

        var properties = new[]
        {
            new Property(typeof(string), "Brand", "Private"),
            new Property(typeof(double), "Budget", "Private"),
            new Property(typeof(IReadOnlyCollection<string>), "Contributors", "Private"),
        };
